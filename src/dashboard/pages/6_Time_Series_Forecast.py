...
# Import shared components and styling
from src.dashboard.components.shared import inject_css, PLOTLY_LAYOUT, TEAL, AMBER, BLUE, RED
inject_css()
...
st.success(f"Dataset loaded: **{len(df_raw):,} rows × {len(df_raw.columns)} columns**")
...
# ─────────────────────────────────────────────────────────────────────────────
# PREPROCESSING (always runs so preview/stats are visible immediately)
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# RUN FORECAST BUTTON + SETTINGS CHANGE DETECTION
# ─────────────────────────────────────────────────────────────────────────────
st.markdown("---")
...
# Only run model when user explicitly clicks the button
if run_btn:
